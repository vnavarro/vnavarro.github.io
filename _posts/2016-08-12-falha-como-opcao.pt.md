---
layout: post
title:  "Percepções sobre falha como uma opção"
...
Falha não é um problema, não deveria ser tratado como um, já discorri sobre esse assunto antes [aqui](http://life-box-of-chocolates.tumblr.com/post/125956640957/it-s-ok-to-fail) e quase um ano depois o TED apresenta o mesmo tema com idéias similares as que expus.

Porque repreender a falha ao invés de elogiá-las? Dentro de certos limites isso só fará bem. Tome a palavra de [Astro Teller](https://www.astroteller.net/) nesse assunto, ele é um membro da [X](https://x.company/) e em seu TED Talk ele confirma que somente transformando falhas em algo bom é que foi possível se tornarem um local tão inovador e com projetos de alta qualidade, mesmo que com pagamentos extras para falhas rápidas. 
...
Para mais percepções sobre falha escute o episódio completo do TED Radio Hour: [Failure is an option](https://www.npr.org/programs/ted-radio-hour/487606750/failure-is-an-option).
...
Deixe suas percepções, comentários e críticas a seguir, vamos construir uma discussão saudável sobre o assunto. Se quiser conversar diretamente me envie um email em <a href="mailto:navsplatypus@duck.com">navsplatypus at duck.com<a>.